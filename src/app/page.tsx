    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-8">
      ...
      <div className="flex items-center justify-between mb-5 sm:mb-6">
        <div className="flex items-baseline gap-4 sm:gap-6">
          ...
          <div className="hidden sm:block h-6 w-24 bg-surface-2 rounded animate-pulse" />
        </div>
      </div>

      {/* Filter bar skeleton - taller inputs */}
      <div className="flex flex-col gap-3 mb-5 sm:mb-6">
        {/* Row 1: Search + desktop filters */}
        <div className="flex items-center gap-3">
          <div className="h-11 sm:h-10 bg-surface border border-border rounded-lg flex-1 sm:max-w-md animate-pulse" />
          <div className="hidden sm:flex items-center gap-2">
            <div className="h-10 w-32 bg-surface border border-border rounded-lg animate-pulse" />
            <div className="h-10 w-36 bg-surface border border-border rounded-lg animate-pulse" />
            <div className="h-10 w-20 bg-surface-2 border border-border rounded-lg animate-pulse" />
          </div>
        </div>

        {/* Row 2: Mobile only */}
        <div className="flex sm:hidden items-center gap-2">
          <div className="h-11 bg-surface border border-border rounded-lg flex-1 animate-pulse" />
          <div className="h-11 bg-surface border border-border rounded-lg flex-1 animate-pulse" />
          <div className="h-11 w-20 bg-surface-2 border border-border rounded-lg flex-shrink-0 animate-pulse" />
        </div>
      </div>

      {/* Grid skeleton - square aspect ratio, larger padding */}
